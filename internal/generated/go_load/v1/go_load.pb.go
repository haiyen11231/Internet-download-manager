...
const (
	DownloadType_DOWNLOAD_TYPE_UNDEFINED DownloadType = 0
	DownloadType_DOWNLOAD_TYPE_HTTP      DownloadType = 1 // Download via HTTP
)

// Enum value maps for DownloadType.
var (
	DownloadType_name = map[int32]string{
		0: "DOWNLOAD_TYPE_UNDEFINED",
...
const (
	DownloadStatus_DOWNLOAD_STATUS_UNDEFINED   DownloadStatus = 0
...
func (x *DownloadTask) GetDownloadType() DownloadType {
	...
	return DownloadType_DOWNLOAD_TYPE_UNDEFINED
}

func (x *DownloadTask) GetFileUrl() string {
	if x != nil {
		return x.FileUrl
	}
	return ""
...
func (x *DownloadTask) GetDownloadStatus() DownloadStatus {
	...
	return DownloadStatus_DOWNLOAD_STATUS_UNDEFINED
}
...
func (x *CreateDownloadTaskRequest) GetFileUrl() string {
	if x != nil {
		return x.FileUrl
	}
	return ""
...
func (x *UpdateDownloadTaskRequest) GetFileUrl() string {
	if x != nil {
		return x.FileUrl
	}
	return ""
...
func (x *GetDownloadTaskFileResponse) GetFileContent() []byte {
	if x != nil {
...
const file_go_load_v1_go_load_proto_rawDesc = "" +
	...
	"\faccount_name\x18\x02 \x01(\tR\vaccountName\"\xf1\x01\n" +
	"\fDownloadTask\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x122\n" +
	"\n" +
	"of_account\x18\x02 \x01(\v2\x13.go_load.v1.AccountR\tofAccount\x12=\n" +
	"\rdownload_type\x18\x03 \x01(\x0e2\x18.go_load.v1.DownloadTypeR\fdownloadType\x12\x19\n" +
	"\bfile_url\x18\x04 \x01(\tR\afileUrl\x12C\n" +
	...
	"\aaccount\x18\x01 \x01(\v2\x13.go_load.v1.AccountR\aaccount\"\x7f\n" +
	"\x19CreateDownloadTaskRequest\x12=\n" +
	"\rdownload_type\x18\x01 \x01(\x0e2\x18.go_load.v1.DownloadTypeR\fdownloadType\x12#\n" +
	"\bfile_url\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\xd0\x0fR\afileUrl\"[\n" +
	...
	"\x19total_download_task_count\x18\x02 \x01(\x04R\x16totalDownloadTaskCount\"j\n" +
	"\x19UpdateDownloadTaskRequest\x12(\n" +
	"\x10download_task_id\x18\x01 \x01(\x04R\x0edownloadTaskId\x12#\n" +
	"\bfile_url\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x88\x01\x01R\afileUrl\"[\n" +
	...
	"\x1bGetDownloadTaskFileResponse\x12!\n" +
	"\ffile_content\x18\x01 \x01(\fR\vfileContent*C\n" +
	"\fDownloadType\x12\x1b\n" +
	"\x17DOWNLOAD_TYPE_UNDEFINED\x10\x00\x12\x16\n" +
	"\x12DOWNLOAD_TYPE_HTTP\x10\x01*\xa6\x01\n" +
	"\x0eDownloadStatus\x12\x1d\n" +
	"\x19DOWNLOAD_STATUS_UNDEFINED\x10\x00\x12\x1b\n" +
	...
	"\x17DOWNLOAD_STATUS_SUCCESS\x10\x042\xbc\x05\n" +
	"\rGoLoadService\x12T\n" +
	"\rCreateAccount\x12 .go_load.v1.CreateAccountRequest\x1a!.go_load.v1.CreateAccountResponse\x12T\n" +
	"\rCreateSession\x12 .go_load.v1.CreateSessionRequest\x1a!.go_load.v1.CreateSessionResponse\x12c\n" +
	"\x12CreateDownloadTask\x12%.go_load.v1.CreateDownloadTaskRequest\x1a&.go_load.v1.CreateDownloadTaskResponse\x12f\n" +
	"\x13GetDownloadTaskList\x12&.go_load.v1.GetDownloadTaskListRequest\x1a'.go_load.v1.GetDownloadTaskListResponse\x12c\n" +
	"\x12UpdateDownloadTask\x12%.go_load.v1.UpdateDownloadTaskRequest\x1a&.go_load.v1.UpdateDownloadTaskResponse\x12c\n" +
	"\x12DeleteDownloadTask\x12%.go_load.v1.DeleteDownloadTaskRequest\x1a&.go_load.v1.DeleteDownloadTaskResponse\x12h\n" +
	"\x13GetDownloadTaskFile\x12&.go_load.v1.GetDownloadTaskFileRequest\x1a'.go_load.v1.GetDownloadTaskFileResponse0\x01B\x85\x01\n" +
