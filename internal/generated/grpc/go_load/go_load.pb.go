...
const file_api_go_load_proto_rawDesc = "" +
	...
	"\aaccount\x18\x01 \x01(\v2\x10.go_load.AccountR\aaccount\"|\n" +
	"\x19CreateDownloadTaskRequest\x12:\n" +
	"\rdownload_type\x18\x01 \x01(\x0e2\x15.go_load.DownloadTypeR\fdownloadType\x12#\n" +
	"\bfile_url\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xd0\x0fR\afileUrl\"X\n" +
	...
	"\bfile_url\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x88\x01\x01R\afileUrl\"X\n" +
